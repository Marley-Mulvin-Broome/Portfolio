...
export const projects: Project[] = [
	...
	},
	{
		...
		description:
			'An addon to the popular flashcard program Anki, allowing the user to generate TTS on the fly.',
	...
	},
	{
		...
		description:
			'A python library which allows for the easy analysis of Japanese text, and the generation of frequency lists.',
